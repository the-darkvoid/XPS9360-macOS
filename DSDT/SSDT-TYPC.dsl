...
//    External (DTGP, MethodObj)
        Scope (\_SB.PCI0.RP01) //We might need a bunch of variables
        {
          Name (RTBT, One)
        }
                                                        ...
                                                        If ((\_SB.PCI0.RP01.SSPD == 0x03))
                                                        {
                                                            If ((\_SB.PCI0.RP01.PXSX.SSPD == 0x03))
                                                            {
                                                                ...
                                                                While ((Timer <= Local2))
                                                                {
                                                                    ...
                                                                    ElseIf ((((\_SB.PCI0.RP01.LTRN != One) && (\_SB.PCI0.RP01.LACT == One)) && (\_SB.PCI0.RP01.PXSX.AVND != 0xFFFFFFFF)))
                                                                    {
                                                                        Local1 = One
                                                                        Break
                                                                    }
